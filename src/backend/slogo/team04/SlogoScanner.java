...
public class SlogoScanner {
     ...
     * @param myFile
     */
    public SlogoScanner(File myFile) throws FileNotFoundException{
    ...
    protected String getNextWord() throws UserInputException{
        ...
        try{
            ...
            throw new UserInputException("Incomplete Slogo program detected"); //TODO make this use resource bundles later
        }
        return myWord;
    }
